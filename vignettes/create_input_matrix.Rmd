...
We suggest shorter filenames than this, which can also be specified with 

```{r, eval=F,echo=T}
nbl_custom_input_matrix<-formSampleMatrixFromRawGDCData(tcga_files = target_files_nbl,format = "custom",binsize = 1e6,freadskip = 14,parallel=F,debug=T,sample_pat = "(?<=30-)(.*?)(?=_)",sample_col = "sample",chrlabel=">chr",startlabel = "begin",endlabel = "end",cnlabel = "relativeCvg")
```

With this, your input matrix is complete. Next, please look at the [next vignette that details recursive linear regression and postprocessing.](create_output_matrix.html)
